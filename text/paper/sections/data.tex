...
and unobservable accounts. {\color{blue} Given that the purpose of our study is to estimate the effect of app use for those users who use the app as intended, this is not necessarily a problem. But further research into how people who do not meet the criteria do actually use the app might shed interesting insights into the barriers that prevent people from using apps like Money Dashboard as intended.}
